...
<section class="cs_pt_135 cs_pt_lg_75 cs_pb_140 cs_pb_lg_80 position-relative">
  <div class="container">
    <div class="row">
      <div class="col-lg-2 cs_mb_lg_55">
      ...
      <div class="cs_about cs_style_1">
        <div class="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_15">
          <div class="cs_section_heading_in">
            ...
            <p class="m-0">Ekky Family Refleksi adalah pusat layanan refleksi dan pijat kesehatan yang berkomitmen untuk memberikan pengalaman relaksasi terbaik bagi keluarga anda. Dengan terapis berpengalaman dan suasana yang nyaman, kami siap membantu anda memanjakan tubuh dan pikiran</p>
          </div>
        </div>
        <!-- .cs_progressbar -->
