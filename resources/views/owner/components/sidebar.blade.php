    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
        <div class="space-y-1">
            <a href="{{ route('owner.dashboard') }}" 
               class="flex items-center px-4 py-3 text-sm font-medium {{ request()->is('owner/dashboard') ? 'text-white bg-gradient-to-r from-[#D79F9E] to-[#C48989] rounded-xl shadow-lg shadow-[#AB6F6E]/30' : 'text-gray-300 rounded-xl hover:bg-white/10 hover:text-white' }} transition-all duration-200">
            ...
            <a href="{{ route('owner.transaksi') }}" 
               class="flex items-center px-4 py-3 text-sm font-medium {{ request()->is('owner/transaksi*') ? 'text-white bg-gradient-to-r from-[#D79F9E] to-[#C48989] rounded-xl shadow-lg shadow-[#AB6F6E]/30' : 'text-gray-300 rounded-xl hover:bg-white/10 hover:text-white' }} transition-all duration-200">
            ...
            <a href="{{ route('owner.laporan-pendapatan') }}" 
               class="flex items-center px-4 py-3 text-sm font-medium {{ request()->is('owner/laporan-pendapatan*') ? 'text-white bg-gradient-to-r from-[#D79F9E] to-[#C48989] rounded-xl shadow-lg shadow-[#AB6F6E]/30' : 'text-gray-300 rounded-xl hover:bg-white/10 hover:text-white' }} transition-all duration-200">
