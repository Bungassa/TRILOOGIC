...
<div class="space-y-8 animate-fade-in pb-10">
    ...
    <div class="flex items-center justify-between">
        <a href="{{ route('owner.penggajian', ['bulan' => $bulan, 'tahun' => $tahun]) }}" class="inline-flex items-center text-gray-600 hover:text-[#825449] font-bold transition-colors group">
            <div class="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center mr-3 group-hover:bg-[#825449] group-hover:text-white transition-all">
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl p-10 border border-white/20 relative overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row items-center gap-8">
            <div class="w-32 h-32 rounded-[2rem] bg-gradient-to-tr from-[#825449] to-[#825449] flex items-center justify-center text-white text-5xl font-black shadow-2xl rotate-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-gradient-to-br from-[#825449] to-[#8D5857] rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50">
                        ...
                        <th class="py-6 px-10 font-bold text-[#825449] uppercase text-[10px] tracking-widest border-b border-gray-100 text-right">Upah (50%)</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    @foreach($records as $record)
                        <tr class="hover:bg-gray-50/80 transition-all group">
                            <td class="py-6 px-10">
                                <div class="font-black text-gray-900 group-hover:text-[#825449] transition-colors text-lg">
                            ...
                            <td class="py-6 px-10 text-right">
                                <div class="text-2xl font-black text-[#825449]">Rp {{ number_format($record->upah_karyawan, 0, ',', '.') }}</div>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
