   ...
   <!-- Start Page Header -->
   <section class="cs_page_header position-relative d-flex align-items-center justify-content-between" style="background-color: #3E3E3E;">
     <div class="container position-relative z-index-1" style="z-index: 5;">
     ...
     <div class="position-absolute end-0 bottom-0" style="z-index: 1;">
