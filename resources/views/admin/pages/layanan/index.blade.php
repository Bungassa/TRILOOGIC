    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg p-6 border border-gray-100">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.layanan.create') }}" class="px-4 py-2 bg-gradient-to-r from-[#825449] to-[#825449] text-white text-sm font-semibold rounded-xl shadow-lg shadow-[#825449]/30">
                    + Tambah Layanan
                </a>
            </div>
        </div>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-4">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('admin.layanan.edit', $layanan->id) }}" class="p-2 text-[#825449] hover:bg-[#e1bdb5] rounded-lg transition-colors">
